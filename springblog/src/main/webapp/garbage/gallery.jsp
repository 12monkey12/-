				...
				<span class="navbar-toggler-icon"></span>
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav ml-4 m-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="javascript:void(0);" onclick="toBlog()">博客 </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="features.jsp">特色</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" href="gallery.jsp"> 画廊 </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="header-right">
                            <a href="javascript:void(0);" class="signin mr-4"> ${user.uname } <i class="fas fa-sign-in-alt"></i></a>
